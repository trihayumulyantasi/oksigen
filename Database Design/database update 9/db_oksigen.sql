...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 05 Feb 2020 pada 04.55
...
('01', 'Shampoo', 2500, 2500, 5, 'Abang', '2020-01-27', 'admin1'),
...
INSERT INTO `detail_transaksi` (`id_detailtrans`, `id_transaksi`, `tanggal`, `waktu`, `nama_barang`, `harga_barang`, `jumlah`) VALUES
(1, '', '04/02/2020', '14.39.19', 'Shampoo', 2500, 2),
(2, '', '04/02/2020', '14.39.23', 'Shampoo bayi', 3000, 2);
...
INSERT INTO `transaksi` (`id_transaksi`, `tanggal`, `waktu`, `total_item`, `diskon`, `total_harga`, `pembayaran`, `kembalian`) VALUES
('001', '04/02/2020', '14.39.50', 4, '10', 9900, 10000, 100),
('040220', '04/02/2020', '14.28.56', 21, '10', 52650, 55000, 2350),
('lbnotransaksi', '04/02/2020', '11.52.09', 12, '10', 38250, 50000, 11750);
...
--
ALTER TABLE `detail_transaksi`
  MODIFY `id_detailtrans` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
COMMIT;
